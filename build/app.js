...
module.exports = require("./src/responsive-child/responsive-child.js");
},{"./src/responsive-child/responsive-child.js":5}],2:[function(require,module,exports){
...
},{"../trapString":7}],5:[function(require,module,exports){
...
},{"../makeEvent":3,"./guest.js":4,"./responsive-child.less":6,"document-register-element":2}],6:[function(require,module,exports){
...
var _require = require("./prefixed");

var transform = _require.transform;
var transformOrigin = _require.transformOrigin;
...
},{"./prefixed":9}],9:[function(require,module,exports){
"use strict";
...
var weeks = Object.keys(byWeek).map(Number).sort(function (a, b) {
  return a - b;
});
...
weekNav.addEventListener("click", function (e) {
  ...
  setTimeout(function () {
    return table.classList.remove("transition");
  }, 500);
});

document.querySelector(".weeks li:last-child a").click();

},{"./lib/flip":8,"./lib/prefixed":9,"./lib/qsa":10,"component-responsive-frame/child":1}]},{},[11])
